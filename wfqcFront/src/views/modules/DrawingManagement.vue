...
const searchFields = [
  ...
  { prop: 'drawing_name', label: '图纸名称', type: 'input', placeholder: '请输入图纸名称' },
  { prop: 'drawing_no', label: '图纸编号', type: 'input', placeholder: '请输入图纸编号' },
  { prop: 'drawing_type', label: '图纸类型', type: 'input', placeholder: '请输入图纸类型' },
  { prop: 'version', label: '版本号', type: 'input', placeholder: '请输入版本号' },
  { prop: 'auditor', label: '审核人', type: 'input', placeholder: '请输入审核人' },
  { prop: 'audit_date', label: '审核日期', type: 'date', placeholder: '请选择审核日期' }
]
...
const exportColumns = [
  ...
  { prop: 'drawing_name', label: '图纸名称' },
  { prop: 'drawing_no', label: '图纸编号' },
  { prop: 'drawing_type', label: '图纸类型' },
  { prop: 'version', label: '版本' },
  { prop: 'auditor', label: '审核人' },
  { prop: 'audit_date', label: '审核日期', formatter: (row) => row.audit_date || '-' },
